/**
 * ============================================================================
 *  PLACEHOLDER CONTENT — REPLACE WITH REAL CLINIC DATA
 * ============================================================================
 *
...
const clinics: ContentSet['clinics'] = [
  {
    slug: 'tanauan',
    name: 'Maralit Dental Clinic — Tanauan',
    shortName: 'Tanauan',
    tagline: 'Our flagship branch, serving Batangas families since 1998.',
    description:
    ...
    coordinates: { lat: 14.0863, lng: 121.1497 },
    mapUrl: 'https://maps.google.com/?q=Tanauan+City+Batangas',
    phone: '(043) 778 1234',
    mobile: '+63 917 555 0101',
    email: 'tanauan@maralitdental.ph',
    accentColor: 'teal',
    hours: [
  ...
  {
    slug: 'lipa',
    name: 'Maralit Dental Clinic — Lipa',
    shortName: 'Lipa',
    tagline: 'Our cosmetic and orthodontic centre in the heart of Lipa City.',
    description:
      'Opened in 2011 and purpose-built around cosmetic and orthodontic work. This branch runs our digital smile-design workflow, intraoral scanning for clear aligners, and in-clinic whitening — alongside the everyday general dentistry every branch provides.',
    isMainBranch: false,
    yearEstablished: 2011,
    address: {
      line1: '45 C.M. Recto Avenue',
      line2: 'Unit 3B, Sabinano Commercial Center',
      barangay: 'Sabang',
      city: 'Lipa City',
      province: 'Batangas',
      postalCode: '4217',
    ...
    coordinates: { lat: 13.9411, lng: 121.1622 },
    mapUrl: 'https://maps.google.com/?q=Lipa+City+Batangas',
    phone: '(043) 756 7788',
    mobile: '+63 917 555 0202',
    email: 'lipa@maralitdental.ph',
    accentColor: 'indigo',
    hours: [
      { day: 0, closed: true },
    ...
    highlights: [
      ...
      'Weeknight appointments until 6:00 PM',
    ],
    amenities: [
      'Mall parking, validated for two hours',
  ...
  {
    slug: 'santo-tomas',
    name: 'Maralit Dental Clinic — Santo Tomas',
    shortName: 'Santo Tomas',
    tagline: 'Neighbourhood care for families, students and shift workers.',
    description:
      'Our community satellite branch, opened in 2019. It focuses on everyday dentistry — check-ups, cleanings, fillings, extractions and children’s care — at accessible prices. Complex cosmetic and implant cases are referred to Tanauan or Lipa, with your records transferred automatically.',
    isMainBranch: false,
    yearEstablished: 2019,
    address: {
      line1: '8 Maharlika Highway',
      line2: 'Beside San Roque Parish',
      barangay: 'San Roque',
      city: 'Santo Tomas',
      province: 'Batangas',
      postalCode: '4234',
    ...
    coordinates: { lat: 14.1079, lng: 121.1416 },
    mapUrl: 'https://maps.google.com/?q=Santo+Tomas+Batangas',
    phone: '(043) 405 2299',
    mobile: '+63 917 555 0303',
    email: 'santotomas@maralitdental.ph',
    accentColor: 'amber',
    hours: [
      { day: 0, closed: true },
...
const staff: ContentSet['staff'] = [
  {
    ...
    bio: 'Founder of Maralit Dental Clinic. Dr. Ramon opened the Tanauan branch in 1998 and still sees patients every weekday morning. He handles restorative and full-mouth rehabilitation cases, and personally reviews every treatment plan that involves more than three teeth.',
    yearsExperience: 28,
    ...
    shifts: [
      { clinicSlug: 'tanauan', day: 1, start: '08:00', end: '12:00' },
      { clinicSlug: 'tanauan', day: 2, start: '08:00', end: '12:00' },
      { clinicSlug: 'tanauan', day: 3, start: '08:00', end: '12:00' },
      { clinicSlug: 'tanauan', day: 4, start: '08:00', end: '12:00' },
      { clinicSlug: 'tanauan', day: 5, start: '08:00', end: '12:00' },
      { clinicSlug: 'tanauan', day: 6, start: '08:00', end: '13:00' },
    ],
  },
  {
    ...
    bio: 'Dr. Cristina completed her orthodontic residency in Manila and has managed more than 900 braces and aligner cases. She splits her week between Tanauan and Lipa, and runs the clinic’s digital treatment-planning workflow.',
    yearsExperience: 16,
    languages: ['Filipino', 'English', 'Spanish'],
    serviceSlugs: ['dental-consultation', 'braces', 'clear-aligners', 'dental-xray'],
    shifts: [
      { clinicSlug: 'tanauan', day: 1, start: '13:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 2, start: '10:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 3, start: '13:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 4, start: '10:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 5, start: '13:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 6, start: '09:00', end: '16:00' },
    ],
  },
  {
    ...
    shifts: [
      { clinicSlug: 'tanauan', day: 2, start: '09:00', end: '17:00' },
      { clinicSlug: 'lipa', day: 3, start: '10:00', end: '18:00' },
      { clinicSlug: 'santo-tomas', day: 5, start: '09:00', end: '17:00' },
      { clinicSlug: 'santo-tomas', day: 6, start: '08:00', end: '14:00' },
    ],
  },
  {
    ...
    shifts: [
      { clinicSlug: 'lipa', day: 1, start: '09:00', end: '16:00' },
      { clinicSlug: 'santo-tomas', day: 2, start: '09:00', end: '17:00' },
      { clinicSlug: 'lipa', day: 4, start: '09:00', end: '16:00' },
      { clinicSlug: 'santo-tomas', day: 6, start: '08:00', end: '14:00' },
    ],
  },
  {
    ...
    shifts: [
      { clinicSlug: 'tanauan', day: 1, start: '12:00', end: '18:00' },
      { clinicSlug: 'santo-tomas', day: 3, start: '09:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 4, start: '09:00', end: '18:00' },
      { clinicSlug: 'santo-tomas', day: 5, start: '09:00', end: '17:00' },
    ],
  },
  {
    ...
    bio: 'Dr. Hannah leads the cosmetic practice at the Lipa branch. She runs the digital smile-design workflow, so patients approve a preview of the result before any tooth is prepared.',
    yearsExperience: 11,
    languages: ['Filipino', 'English'],
    serviceSlugs: [
      'dental-consultation',
    ...
    shifts: [
      { clinicSlug: 'lipa', day: 1, start: '12:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 2, start: '09:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 5, start: '09:00', end: '18:00' },
      { clinicSlug: 'lipa', day: 6, start: '09:00', end: '16:00' },
    ],
  },
  {
    ...
    bio: 'Dr. Jerome places and restores dental implants at the Tanauan branch, where the CBCT scanner and in-house laboratory let him plan and deliver a case without outside referrals.',
    yearsExperience: 13,
    languages: ['Filipino', 'English'],
    serviceSlugs: ['dental-consultation', 'dental-implants', 'dental-crown', 'dental-xray'],
    shifts: [
      { clinicSlug: 'tanauan', day: 3, start: '09:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 4, start: '09:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 6, start: '09:00', end: '17:00' },
    ],
  },
  {
    slug: 'grace-mendoza',
    ...
    bio: 'Grace handles cleanings, sealants and fluoride treatments at Tanauan, and runs the clinic’s school oral-health outreach programme across Batangas.',
    yearsExperience: 8,
    languages: ['Filipino', 'English'],
    serviceSlugs: ['oral-prophylaxis', 'fluoride-sealant'],
    shifts: [
      { clinicSlug: 'tanauan', day: 1, start: '08:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 2, start: '08:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 3, start: '08:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 4, start: '08:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 5, start: '08:00', end: '17:00' },
      { clinicSlug: 'tanauan', day: 6, start: '08:00', end: '13:00' },
    ],
  },
  {
    ...
    bio: 'Bea splits her week between Lipa and Santo Tomas, covering cleanings, sealants and periodontal maintenance for both branches.',
    yearsExperience: 6,
    languages: ['Filipino', 'English'],
    serviceSlugs: ['oral-prophylaxis', 'fluoride-sealant'],
    shifts: [
      { clinicSlug: 'lipa', day: 1, start: '09:00', end: '18:00' },
      { clinicSlug: 'santo-tomas', day: 2, start: '09:00', end: '17:00' },
      { clinicSlug: 'lipa', day: 3, start: '09:00', end: '18:00' },
      { clinicSlug: 'santo-tomas', day: 4, start: '09:00', end: '17:00' },
      { clinicSlug: 'lipa', day: 5, start: '09:00', end: '18:00' },
    ],
  },
  {
    ...
    bio: 'Andrei is the senior dental assistant at Santo Tomas, responsible for chairside support, instrument sterilisation and infection control across the branch.',
    yearsExperience: 5,
    languages: ['Filipino', 'English'],
    serviceSlugs: [],
    shifts: [
...
export const organization = {
  ...
  shortName: 'MDCAS',
  tagline: 'Three branches across Batangas. One standard of care.',
  description:
    'Maralit Dental Clinic has cared for Batangas families since 1998. Across our three branches you will find the same clinical standards, the same shared patient records, and a schedule you can check before you travel.',
  ...
  stats: [
    ...
    { label: 'Branches in Batangas', value: '3' },
...
export const staffUsers: Array<{
  ...
  },
  {
    ...
    name: 'Dr. Paolo Villanueva',
    role: 'dentist',
    clinicSlugs: ['tanauan', 'lipa', 'santo-tomas'],
